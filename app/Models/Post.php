...
final class Post
{
    ...
    public static function allAdmin(): array { return Database::connection()->query(self::SELECT.' GROUP BY p.id ORDER BY p.created_at DESC')->fetchAll(); }
