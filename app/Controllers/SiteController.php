...
use App\Core\Controller; use App\Models\Category; use App\Models\Post; use App\Models\Setting;
final class SiteController extends Controller
{
    public function home(): void { $posts=Post::published(40); $this->render('site/home',['title'=>'La voz de nuestra gente','featured'=>array_shift($posts),'posts'=>$posts,'categories'=>Category::all(),'weather'=>Setting::weather()]); }
