...
{
    public function home(): void { $posts=Post::published(13); $this->render('site/home',['title'=>'La voz de nuestra gente','featured'=>array_shift($posts),'posts'=>$posts,'categories'=>Category::all()]); }
